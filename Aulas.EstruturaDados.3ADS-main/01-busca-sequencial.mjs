...
console.time('Buscando ABACUQUE...')      // Dispara a contagem de tempo
console.log('Posição de ABACUQUE:', buscaSequencial(nomes, 'ABACUQUE'))
console.timeEnd('Buscando ABACUQUE...')   // Para a contagem de tempo
